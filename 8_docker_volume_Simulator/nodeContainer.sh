...
gnome-terminal --title=node$NODE -- sh -c "docker run --network IoT-net -v .:/appbuild/IoT-System/nodes/$NODE --rm -it --name iotnode$NODE --ip 172.28.1.$NODE iotnode$NODE; bash"
rm -r appbuild
rm Dockerfile
rm toBeRun
cd ../../..